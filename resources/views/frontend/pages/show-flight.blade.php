...
<div style="margin:40px;">
    ...
    <div class="row" style="padding:50px; background-color: white;  border:1px solid gray;">
        ...
        <div class="col-md-2">
            <div class="fw-tripinfo-label"><h6></div></h6>
                                           <h6>  Flight_Number</h6>
            <div class="fw-tripinfo-time"><h6>{{$Flight->number}}</div></h6>

                                       <h6> Arrival_Time</h6>
            <div class="fw-tripinfo-date"><h6>{{$Flight->arrival_time}}</div></h6>
        ...
        <div class="col-md-2">
            ...
            <div class="fw-tripinfo-label" style="padding-top: 10px;">
                        <h6> Destination</h6>
            <div class="fw-tripinfo-day"><h6>{{$Flight->destination}}</div></h6>
            </div>
        ...
        <div class="fw-fareinfo col-md-2">
            <div class="fw-tripinfo-label"><h6>Price</div></h6>
            <div class="fw-fare-currency-label"><h6>{{$Flight->price}}</div></h6>
